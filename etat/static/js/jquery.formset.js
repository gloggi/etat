...
;(function($) {
    $.fn.formset = function(opts)
    {
        var options = $.extend({}, $.fn.formset.defaults, opts),
            ...
            insertDeleteLink = function(row, del) {
                if (row.is('TR')) {
                ...
                row.find('a.' + options.deleteCssClass.split(' ').join('.')).click(function() {
    ...
    $.fn.formset.defaults = {
        ...
        deleteCssClass: 'btn btn-danger pull-right',
