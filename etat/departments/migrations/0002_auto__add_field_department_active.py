...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Department.active'
        db.add_column(u'departments_department', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Department.active'
        db.delete_column(u'departments_department', 'active')
