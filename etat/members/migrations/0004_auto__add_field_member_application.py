...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Member.application'
        db.add_column(u'members_member', 'application',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Member.application'
        db.delete_column(u'members_member', 'application')
